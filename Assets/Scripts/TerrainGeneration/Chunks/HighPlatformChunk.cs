...
public class HighPlatformChunk : MonoBehaviour {
	...
	public static Vector3 Generate(Vector3 start, float width, float height)
	{
		...
		GameObject platformInst = Instantiate (terrainManager.platform, new Vector3(start.x+width/2.0F,start.y+Random.Range(15f,20f),0), new Quaternion(0,0,0,0))as GameObject;
